<html> 
  ...
  <body> 
    <h1>EJERCICIO 3_1: ANALISIS DE FORMULARIO Version 3
     Todo en una pagina</h1><br> 
    <br> 
    ...
    <form action="25_analisis.php" method="post"> 
      ...
      ?> 
      <ol>
        <li>¿Qué hace la funcion isset()?</li>
          <p>Determina si una variable está definida y no es NULL.</p>
        <li>¿Cuáles son los operadores relacionales que estamos usando?</li>
          <p>&& = y</p>
          <p>!= = Que no se igual</p>
      </ol>
  </body> 
