<html>
	...
	<body>
		...
		?>
			<ol>
				<li>Qué hace htmlspecialchars()?</li>
					<p>Convierte caracteres especiales en entidades HTML</p>
				<li>¿Qué hace stripslahses()?</li>
					<p>Desmarca la cadena marcada con addcslashes()</p>
				<li>¿Qué hace readfile()?</li>
					<p>Realizar la salida de un fichero</p>
			</ol>
	</body>
</html>